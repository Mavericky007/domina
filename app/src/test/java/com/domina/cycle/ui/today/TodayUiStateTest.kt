...
class TodayUiStateTest {
    ...
    @Test fun noFlowLogsYieldNoneConfidenceAndNoGuidance() {
        val state = TodayViewModel.buildState(emptyList(), d("2026-05-10"), AppMode.CYCLE)
    ...
    @Test fun derivesPredictionAndGuidanceFromFlowLogs() {
        ...
        val state = TodayViewModel.buildState(logs, d("2026-05-05"), AppMode.CYCLE)
    ...
    @Test fun exposesTodaysLogWhenPresent() {
        ...
        val state = TodayViewModel.buildState(logs, d("2026-05-10"), AppMode.CYCLE)
